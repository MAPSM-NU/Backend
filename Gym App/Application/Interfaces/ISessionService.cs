...
namespace Gym_App.Application.Interfaces
{
    public interface ISessionService
    {
        ...
        Task<int> AddMessages(ClaimsPrincipal User, Guid sessionID,List<Guid> messages);
        Task<int> DeleteMessages(ClaimsPrincipal User, Guid sessionID, List<Guid> messages);
